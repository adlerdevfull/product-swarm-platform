  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      <div class="bg-white rounded-xl shadow-sm border p-5">
        <p class="text-xs uppercase text-slate-400">Products</p>
        <p class="text-3xl font-bold text-indigo-600 mt-1">{{ products.length }}</p>
      </div>
      <div class="bg-white rounded-xl shadow-sm border p-5">
        <p class="text-xs uppercase text-slate-400">Orders</p>
        <p class="text-3xl font-bold text-emerald-600 mt-1">{{ orders.length }}</p>
      </div>
      <div class="bg-white rounded-xl shadow-sm border p-5">
        <p class="text-xs uppercase text-slate-400">API Health</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-5">
      <h3 class="font-semibold mb-3">Stack (job match)</h3>
